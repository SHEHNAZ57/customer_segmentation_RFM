...
👉 \[Open the Customer Intelligence Dashboard](https://customersegmentationrfm-w4fz5bug2rm9eb56nnfeuy.streamlit.app/)
...
The combined `RFM\_Score` is a **customer profile code**, not a single numerical magnitude.
...
`.ipynb\_checkpoints` may also be created automatically by Jupyter.
...
```bash
cd OneDrive\\customer\_segmentation
```
